import { usarRemoveUsuario } from "@/apis/administracion/apisUsuarios";
...
export default function EliminarUsuario({
  ...
  } = usarRemoveUsuario(idColumna.toString());
  ...
  if (isSuccess) {
    ...
    exitoToast(`Se elimino el usuario: ${usuarioEliminado.nombres}`);
