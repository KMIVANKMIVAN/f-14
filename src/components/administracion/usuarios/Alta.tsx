import { usarUpdateUsuarioDarAlta } from "@/apis/administracion/apisUsuarios";
...
export default function Alta({
  ...
  } = usarUpdateUsuarioDarAlta(idColumna.toString());
  ...
  if (isSuccess) {
    ...
    exitoToast(`Se dio alta al usuario: ${usuarioDadoAlta.nombres}`);
