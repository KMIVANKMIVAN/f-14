import { usarUpdateUsuarioResetearpw } from "@/apis/administracion/apisUsuarios";
...
export default function RestablecerContra({
  ...
  } = usarUpdateUsuarioResetearpw(idColumna.toString());
  ...
  if (isSuccess) {
    ...
    exitoToast(`Se reseteo la contr al usuario: ${usuarioDadoAlta.nombres}`);
